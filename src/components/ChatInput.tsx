        ...
        <div className="w-full pt-1 px-3 sm:px-6 bg-transparent">
          ...
          >
            ...
            {/* INPUT PANEL */}
              ...
              >
                <div className={`relative rounded-[32px] transition-all duration-500 ${isAwakened || effectInputBox ? 'p-[2px] shadow-[0_0_40px_rgba(0,242,255,0.4)]' : 'p-[1px] bg-gradient-to-br from-slate-300 to-slate-200 dark:from-white/20 dark:to-white/5 shadow-md'}`}>
                      ...
                      <div className="flex flex-wrap gap-2 px-2 pb-2">
                        {attachments.map((att, index) => (
                          <div key={index} className="relative group w-16 h-16 sm:w-20 sm:h-20 rounded-xl overflow-hidden border border-slate-200 dark:border-white/10 shadow-sm">
                            <img src={att.data ? `data:${att.mimeType};base64,${att.data}` : att.url} alt={`attachment-${index}`} className="w-full h-full object-cover" />
                            <button
